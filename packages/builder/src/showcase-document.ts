...
export function createShowcaseDocument(): BuilderDocument {
  ...
  const layoutSection = sectionContainer(
    ...
    [
      el("grid", { columns: 2, rows: 1, gap: 24, justify: "stretch", align: "stretch", tag: "section" }, {
        styles: { desktop: { normal: { display: "grid" } } },
        children: [
          el("div-block", { tag: "section", link: "#div-block-demo" }, {
            styles: {
              desktop: {
                normal: {
                  paddingTop: 24,
          ...
          el("flexbox", { contentWidth: "boxed", tag: "section", link: "#flexbox-demo" }, {
            styles: {
              desktop: {
                normal: {
                  display: "flex",
            ...
            children: [
              el("icon", { icon: "▦", view: "stacked", shape: "circle", primaryColor: "#6d5dfc", secondaryColor: "#fff", size: 36, link: "#icon", align: "center", fitToSize: true, padding: 6, rotate: 15, borderWidth: 2, borderRadius: 50 }),
              el("icon", { icon: "▭", view: "framed", shape: "square", primaryColor: "#7c3aed", size: 36, borderWidth: 2, link: "#icon-framed" }),
            ],
          }),
        ],
      }),
      el("container", {
        ...
        children: [
          el("paragraph", { text: "Grid-layout container with boxed content width.", align: "center" }),
          el("icon", { icon: "▦", view: "stacked", shape: "square", primaryColor: "#059669", secondaryColor: "#fff", size: 40 }),
        ],
      }),
      el("spacer", { height: 16 }),
      el("container", {
        ...
        children: [
          el("div-block", { tag: "div" }, {
            children: [
              ...
              el("heading", { text: "Heading Small", tag: "h4", size: "small", align: "left" }),
              el("paragraph", {
  ...
  const mediaSection = sectionContainer(
    ...
    [
      ...
      el("carousel", {
        ...
        images: galleryImages.slice(0, 4).map((item) => ({ src: item.src, alt: item.alt, url: item.src })),
        slidesToShow: "3",
        slidesToScroll: "2",
        navigation: "both",
        imageStretch: "yes",
  ...
  const contentBlocks = sectionContainer(
    ...
    [
      ...
      el("tabs", {
        ...
        align: "start",
        titleColor: "#6b7280",
        activeTitleColor: "#7c3aed",
        contentColor: "#374151",
        titleSpacing: 12,
        items: [
          { title: "Morning", content: "Coffee, pastries, and fresh juice bars open from 7am." },
          { title: "Afternoon", content: "Lunch vendors, grab-and-go options, and coworking lounges." },
          { title: "Evening", content: "Dinner service, live music, and rooftop events." },
        ],
      }),
      el("grid", { columns: 2, gap: 24 }, {
        children: [
  ...
  const statsSection = sectionContainer(
    ...
    [
      ...
      el("icon-list", {
        ...
        textSize: 15,
        items: [
          { text: "Free Wi-Fi throughout the market", icon: "📶", url: "#wifi" },
          { text: "Pet-friendly outdoor seating", icon: "🐾", url: "#pets" },
          { text: "Accessible entrances and restrooms", icon: "♿", url: "#accessibility" },
